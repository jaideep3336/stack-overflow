    ...
    </label>
    {
        isSignup && (
            <label htmlFor='check'>
                ...
                <p>Opt-in to receive occasional,<br /> product updates, user research invitations,<br/>
    ...
    <button type='submit' className='auth-btn'>{ isSignup ? 'sign up' : 'Log in' }</button>
    {
        isSignup && (
            <p style={{color: "#666767", fontSize:"13px"}}>
                By clicking “Sign up”, you agree to o u
 <span style={{color: "#007ac6"}}>terms ofservice,</span> 
